                    ...
                    <Card key={event.id}>
                        <CardHeader className="bg-slate-50 dark:bg-slate-900/40">
                            <CardTitle className="text-lg flex items-center justify-between">
                                <span>{event.title} <span className="text-sm font-normal text-muted-foreground">({new Date(event.date).toLocaleDateString('en-GB', { timeZone: 'Asia/Kolkata' })})</span></span>
                            </CardTitle>
                        </CardHeader>
