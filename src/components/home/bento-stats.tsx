...
export function BentoStats() {
    return (
        <section className="py-10 md:py-20 bg-slate-50 dark:bg-slate-950 relative overflow-hidden">
            <div className="container px-4 mx-auto">
                <ScrollReveal>
                    <div className="text-center max-w-2xl mx-auto mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold tracking-tight text-slate-900 dark:text-white mb-3">
                    ...
                    {stats.map((stat, index) => (
                        <ScrollReveal key={index} delay={index * 0.1}>
                            <motion.div
                                ...
                                className={`h-full w-full p-6 rounded-3xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm hover:shadow-xl transition-all group flex flex-col justify-between overflow-hidden relative`}
                            >
                                ...
                                <div className="relative z-10">
                                    <div className={`inline-flex p-2.5 rounded-2xl ${stat.color} text-white mb-4 shadow-lg shadow-current/10`}>
